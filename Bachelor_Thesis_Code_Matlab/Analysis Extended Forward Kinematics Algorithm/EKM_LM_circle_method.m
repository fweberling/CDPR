% EKM Levenberg-Marquardt with circle method (EKM LM circle method)
...
for iterations_1=1:m
    ...
    for iterations_2=1:robot.steps
        ...
        % Levenberg-Marquardt Extended Kinematic Model (EKM) with circle method for initial estimate
...
matlab2tikz('EKM_LM_circle_method.tex');
