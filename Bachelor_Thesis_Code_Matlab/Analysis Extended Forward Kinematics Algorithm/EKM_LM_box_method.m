% EKM Levenberg-Marquardt with box method (EKM LM box method)
...
for iterations_1=1:m
    ...
    for iterations_2=1:robot.steps
        ...
        % Levenberg-Marquard Extended Kinematic Model (EKM) with box method for inital estimate
...
matlab2tikz('EKM_LM_box_method.tex');