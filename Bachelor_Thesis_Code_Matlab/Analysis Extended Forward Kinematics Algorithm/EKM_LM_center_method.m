% EKM Levenberg-Marquardt with center method (EKM LM center method)

%Definition of Input Parameters for Model
%format long;

% Generating object robot of class Robot
robot=Robot;
...
for iterations_1=1:m
    ...
    for iterations_2=1:robot.steps
        ...
        % Levenberg-Marquardt Extended Kinematic Model (EKM) with center method
...
for iterations_1=1:m
    ...
    for iterations_2=1:robot.steps
        ...
        robot.epsilon_1=10^-5; %proposed 10^-5
        robot.epsilon_2=10^-5; %proposed 10^-5
        [~,iterations_LM]=Levenberg_Marquardt_EKM(robot);
...
for iterations_1=1:m
    ...
    for iterations_2=1:robot.steps
        ...
        robot.y_0=0;
        robot.phi_0=0;
        [X_LM,iterations_LM]=Levenberg_Marquardt_EKM(robot);
...
matlab2tikz('EKM_LM_center_method.tex');