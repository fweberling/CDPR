% SKM Levenberg-Marquardt with box method (SKM LM box method)

%Definition of Input Parameters for Model
%format long;

% Generating object robot from class Robot
robot=Robot;
...
for iterations_1=1:m
    ...
    for iterations_2=1:robot.steps
        robot.position=[x(1,iterations_2);y_vector;0];
         ...
         % Levenberg-Marquard (SKM) with box method for inital estimate
        robot.L_SKM=inverse_kinematics_SKM(robot);
...
matlab2tikz('SKM_LM_box_method.tex');