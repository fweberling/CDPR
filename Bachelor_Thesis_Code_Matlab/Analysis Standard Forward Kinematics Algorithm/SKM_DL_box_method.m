% SKM Dog Leg with box method (SKM DL box method)

%Definition of Input Parameters for Model
%format long;

% generating the object robot from the class Robot
robot=Robot;
...
% position of cable attachment in K_P
...
matlab2tikz('SKM_DL_box_method.tex');